(function(j, m) {
    ...
    function x(e) {
        if (!Xa[e]) {
            ...
            b.remove();
            if ("none" === a || "" === a) {
                da || (da = o.createElement("iframe"),
                da.frameBorder = da.width = da.height = 0);
                n.appendChild(da);
                if (!na || !da.createElement)
                    na = (da.contentWindow || da.contentDocument).document,
                    na.write(("CSS1Compat" === o.compatMode ? "<!doctype html>" : "") + "<html><body>"),
                    na.close();
    ...
    function y(e, n) {
        var b = {};
        c.each(mb.concat.apply([], mb.slice(0, n)), function() {
            b[this] = e
        });
        return b
    }
    ...
    function J(e, n, c, b, a, d) {
        ...
        d = d || {};
        d[a] = !0;
        for (var a = e[a], h = 0, g = a ? a.length : 0, l = e === Ya, f; h < g && (l || !f); h++)
            f = a[h](n, c, b),
            "string" == typeof f && (!l || d[f] ? f = m : (n.dataTypes.unshift(f),
            f = J(e, n, c, b, f, d)));
        (l || !f) && !d["*"] && (f = J(e, n, c, b, "*", d));
        return f
    }
    function K(e) {
        return function(n, b) {
            ...
            n = "*");
            if (c.isFunction(b))
                for (var a = n.toLowerCase().split(nb), d = 0, h = a.length, g, l; d < h; d++)
                    g = a[d],
    ...
    function Q(e, n, b) {
        var a = "width" === n ? e.offsetWidth : e.offsetHeight
          , d = "width" === n ? Tb : Ub;
        if (0 < a)
            return "border" !== b && c.each(d, function() {
    ...
    function V(e, n) {
        ...
        if (1 === n.nodeType) {
            ...
            if ("object" === a)
            ...
            else if ("input" !== a || "checkbox" !== e.type && "radio" !== e.type)
                if ("option" === a)
                ...
                e.checked && (n.defaultChecked = n.checked = e.checked),
    ...
    function D(e, n) {
        if (1 === n.nodeType && c.hasData(e)) {
            ...
            var h = c._data(n, b)
              , g = b.events;
            if (g)
                for (a in delete h.handle,
                h.events = {},
                g) {
                    b = 0;
                    for (d = g[a].length; b < d; b++)
                        c.event.add(n, a + (g[a][b].namespace ? "." : "") + g[a][b].namespace, g[a][b], g[a][b].data)
                }
    ...
    function w(e) {
        ...
        if (e.createElement)
            for (; n.length; )
                e.createElement(n.pop());
        return e
    }
    function aa(e, n, a) {
        n = n || 0;
        if (c.isFunction(n))
            return c.grep(e, function(e, b) {
        ...
        if ("string" == typeof n) {
            var b = c.grep(e, function(e) {
                return 1 === e.nodeType
            });
            if (Wb.test(n))
                return c.filter(n, b, !a);
            n = c.filter(n, b)
        }
        return c.grep(e, function(e) {
    ...
    function U(e, n, a) {
        var b = n + "defer"
          ...
          , h = n + "mark"
          , g = c._data(e, b);
        g && ("queue" === a || !c._data(e, d)) && ("mark" === a || !c._data(e, h)) && setTimeout(function() {
            !c._data(e, d) && !c._data(e, h) && (c.removeData(e, b, !0),
            g.fire())
        }, 0)
    }
    function R(e) {
        for (var n in e)
            if (!("data" === n && c.isEmptyObject(e[n])) && "toJSON" !== n)
                return !1;
        return !0
    }
    function M(e, n, a) {
        if (a === m && 1 === e.nodeType)
            if (a = "data-" + n.replace(Xb, "-$1").toLowerCase(),
            a = e.getAttribute(a),
            "string" == typeof a) {
                try {
    ...
    var o = j.document, F = j.location, c, i = function() {
        if (!f.isReady) {
            try {
    ...
    }, p = j.jQuery, v = j.$, b, d = /^(?:[^#<]*(<[\w\W]+>)[^>]*$|#([\w\-]*)$)/, a = /\S/, h = /^\s+/, g = /\s+$/, l = /\d/, t = /^<(\w+)\s*\/?>(?:<\/\1>)?$/, z = /^[\],:{}\s]*$/, ya = /\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g, ja = /"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g, I = /(?:^|:|,)(?:\s*\[)+/g, Zb = /(webkit)[ \/]([\w.]+)/, $b = /(opera)(?:.*version)?[ \/]([\w.]+)/, ac = /(msie) ([\w.]+)/, bc = /(mozilla)(?:.*? rv:([\w.]+))?/, cc = /-([a-z]|[0-9])/ig, E = /^-ms-/, dc = function(e, n) {
        return (n + "").toUpperCase()
    }, ec = j.navigator.userAgent, Ea, Fa, O, fc = Object.prototype.toString, Za = Object.prototype.hasOwnProperty, P = Array.prototype.push, fa = Array.prototype.slice, ha = String.prototype.trim, pa = Array.prototype.indexOf, ga = {};
    f.fn = f.prototype = {
        constructor: f,
        init: function(e, n, a) {
            var b, c;
            ...
            if ("string" == typeof e) {
                ...
                if (b && (b[1] || !n)) {
                    if (b[1])
                        return c = (n = n instanceof f ? n[0] : n) ? n.ownerDocument || n : o,
                        (a = t.exec(e)) ? f.isPlainObject(n) ? (e = [o.createElement(a[1])],
                        f.fn.attr.call(e, n, !0)) : e = [c.createElement(a[1])] : (a = f.buildFragment([b[1]], [c]),
                        e = (a.cacheable ? f.clone(a.fragment) : a.fragment).childNodes),
                        f.merge(this, e);
            ...
            if (f.isFunction(e))
                return a.ready(e);
            e.selector !== m && (this.selector = e.selector,
        ...
        map: function(e) {
            return this.pushStack(f.map(this, function(n, a) {
                return e.call(n, a, n)
            }))
        },
        end: function() {
    ...
    f.extend = f.fn.extend = function() {
        var e, n, a, b, c, d, h = arguments[0] || {}, g = 1, l = arguments.length, i = !1;
        "boolean" == typeof h && (i = h,
        h = arguments[1] || {},
        g = 2);
        ...
        --g); g < l; g++)
            if (null != (e = arguments[g]))
                for (n in e)
                    a = h[n],
                    b = e[n],
                    h !== b && (i && b && (f.isPlainObject(b) || (c = f.isArray(b))) ? (c ? (c = !1,
                    d = a && f.isArray(a) ? a : []) : d = a && f.isPlainObject(a) ? a : {},
    ...
    f.extend({
        ...
        ready: function(e) {
            if (!0 === e && !--f.readyWait || !0 !== e && !f.isReady) {
                ...
                f.isReady = !0;
                !0 !== e && 0 < --f.readyWait || (Fa.fireWith(o, [f]),
                f.fn.trigger && f(o).trigger("ready").unbind("ready"))
            }
        },
        bindReady: function() {
            if (!Fa) {
        ...
        isPlainObject: function(e) {
            if (!e || "object" !== f.type(e) || e.nodeType || f.isWindow(e))
                return !1;
            try {
                if (e.constructor && !Za.call(e, "constructor") && !Za.call(e.constructor.prototype, "isPrototypeOf"))
                    return !1
            } catch (n) {
                return !1
            }
        ...
        parseJSON: function(e) {
            ...
            if (z.test(e.replace(ya, "@").replace(ja, "]").replace(I, "")))
        ...
        parseXML: function(e) {
            var n, a;
            try {
                j.DOMParser ? (a = new DOMParser,
                n = a.parseFromString(e, "text/xml")) : (n = new ActiveXObject("Microsoft.XMLDOM"),
                n.async = "false",
                n.loadXML(e))
            } catch (b) {
                n = m
        ...
        globalEval: function(e) {
            e && a.test(e) && (j.execScript || function(e) {
                j.eval.call(j, e)
            }
            )(e)
        },
        ...
        each: function(e, n, a) {
            var b, c = 0, d = e.length, h = d === m || f.isFunction(e);
            if (a)
                if (h)
                    for (b in e) {
                        if (!1 === n.apply(e[b], a))
                    ...
                    for (; c < d && !1 !== n.apply(e[c++], a); )
                        ;
            else if (h)
                for (b in e) {
                    if (!1 === n.call(e[b], b, e[b]))
                        break
                }
            else
                for (; c < d && !1 !== n.call(e[c], c, e[c++]); )
                    ;
            return e
        },
        trim: ha ? function(e) {
        ...
        grep: function(e, a, b) {
            for (var c = [], d, b = !!b, h = 0, g = e.length; h < g; h++)
                d = !!a(e[h], h),
                b !== d && c.push(e[h]);
            return c
        },
        map: function(e, a, b) {
            var c, d, h = [], g = 0, l = e.length;
            if (e instanceof f || l !== m && "number" == typeof l && (0 < l && e[0] && e[l - 1] || 0 === l || f.isArray(e)))
                for (; g < l; g++)
                    c = a(e[g], g, b),
                    null != c && (h[h.length] = c);
            else
        ...
        access: function(e, a, b, c, d, h) {
            ...
            if ("object" == typeof a) {
                for (var l in a)
                    f.access(e, l, a[l], c, d, b);
                return e
            }
            if (b !== m) {
                c = !h && c && f.isFunction(b);
                for (l = 0; l < g; l++)
                    d(e[l], a, c ? b.call(e[l], l, d(e[l], a)) : b, h);
                return e
            }
            return g ? d(e[0], a) : m
        },
    ...
    f.each("Boolean Number String Function Array Date RegExp Object".split(" "), function(e, a) {
        ga["[object " + a + "]"] = a.toLowerCase()
    });
    Ea = f.uaMatch(ec);
    Ea.browser && (f.browser[Ea.browser] = !0,
    f.browser.version = Ea.version);
    ...
    c.Callbacks = function(e) {
        ...
        if (e) {
            ...
            a = {};
        var e = a, g = [], l = [], f, i, j, t, k, z = function(a) {
            var b, n, d, h;
            b = 0;
            ...
            k = j || 0;
            j = 0;
            for (t = g.length; g && k < t; k++)
                if (!1 === g[k].apply(a, b) && e.stopOnFalse) {
                    f = !0;
                    break
                }
            i = !1;
            g && (e.once ? !0 === f ? v.disable() : g = [] : l && l.length && (f = l.shift(),
            v.fireWith(f[0], f[1])))
        }, v = {
            add: function() {
                if (g) {
            ...
            remove: function() {
                if (g)
                    for (var a = arguments, b = 0, n = a.length; b < n; b++)
                        for (var c = 0; c < g.length && !(a[b] === g[c] && (i && c <= t && (t--,
                        c <= k && k--),
                        g.splice(c--, 1),
                        e.unique)); c++)
                            ;
    ...
    c.extend({
        Deferred: function(e) {
            var a = c.Callbacks("once memory"), b = c.Callbacks("once memory"), d = c.Callbacks("memory"), h = "pending", g = {
                resolve: a,
                reject: b,
                notify: d
            }, l = {
                ...
                pipe: function(e, a, b) {
                    return c.Deferred(function(n) {
                        c.each({
                            ...
                            var b = a[0], d = a[1], h;
                            c.isFunction(b) ? f[e](function() {
                                (h = b.apply(this, arguments)) && c.isFunction(h.promise) ? h.promise().then(n.resolve, n.reject, n.notify) : n[d + "With"](this === f ? n : this, [h])
                            }) : f[e](n[d])
                        })
                    }).promise()
                },
        ...
        when: function(e) {
            ...
            function b(e) {
                return function(a) {
                    d[e] = 1 < arguments.length ? $a.call(arguments, 0) : a;
                    --f || i.resolveWith(i, d)
                }
            }
            ...
            if (1 < g) {
                for (; h < g; h++)
                    d[h] && d[h].promise && c.isFunction(d[h].promise) ? d[h].promise().then(b(h), i.reject, a(h)) : --f;
                f || i.resolveWith(i, d)
            } else
                i !== e && i.resolveWith(i, g ? [e] : []);
            return j
        }
    });
    var gc = c, ab;
    var G = o.createElement("div"), hc = o.documentElement, bb, qa, Ga, Ha, Z, ra, T, Ia, ba, Ja, W, Ka, za, La, sa, Aa;
    ...
    if (!bb || !bb.length || !qa)
        ...
        G.style.zoom = 1,
        T.inlineBlockNeedsLayout = 2 === G.offsetWidth,
        G.style.display = "",
        ...
        G.innerHTML = "";
        o.defaultView && o.defaultView.getComputedStyle && (ra = o.createElement("div"),
        ra.style.width = "0",
        ra.style.marginRight = "0",
        G.appendChild(ra),
        T.reliableMarginRight = 0 === (parseInt((o.defaultView.getComputedStyle(ra, null) || {
            marginRight: 0
        }).marginRight, 10) || 0));
        if (G.attachEvent)
            for (sa in {
                ...
                La = "on" + sa,
                (Aa = La in G) || (G.setAttribute(La, "return;"),
                Aa = "function" == typeof G[La]),
                T[sa + "Bubbles"] = Aa;
        c(function() {
            var e, a, b, d, h;
            ba = o.getElementsByTagName("body")[0];
            !ba || (e = o.createElement("div"),
            ...
            W.style.cssText = "position:absolute;top:0;left:0;width:1px;height:1px;margin:0;visibility:hidden;border:0;",
            W.innerHTML = "<div style='position:absolute;top:0;left:0;width:1px;height:1px;margin:0;border:5px solid #000;padding:0;'><div></div></div><table style='position:absolute;top:0;left:0;width:1px;height:1px;margin:0;border:5px solid #000;padding:0;' cellpadding='0' cellspacing='0'><tr><td></td></tr></table>",
            e.appendChild(W),
            a = W.firstChild,
            b = a.firstChild,
            ...
            b.style.top = "20px",
            h.fixedPosition = 20 === b.offsetTop || 15 === b.offsetTop,
            b.style.position = b.style.top = "",
            a.style.overflow = "hidden",
            a.style.position = "relative",
            h.subtractsBorderForOverflowNotVisible = -5 === b.offsetTop,
            h.doesNotIncludeMarginInBodyOffset = 1 !== ba.offsetTop,
            ba.removeChild(e),
            W = null,
            c.extend(T, h))
        });
    ...
    c.extend({
        ...
        data: function(e, a, b, d) {
            if (c.acceptData(e)) {
                var h, g, l = "string" == typeof a, f = (h = e.nodeType) ? c.cache : e, i = h ? e[c.expando] : e[c.expando] && c.expando, j = "events" === a;
                if (i && f[i] && (j || d || f[i].data) || !(l && b === m)) {
                    i || (h ? e[c.expando] = i = ++c.uuid : i = c.expando);
                    f[i] || (f[i] = {},
                    h || (f[i].toJSON = c.noop));
                    if ("object" == typeof a || "function" == typeof a)
                        d ? f[i] = c.extend(f[i], a) : f[i].data = c.extend(f[i].data, a);
                    e = h = f[i];
                    d || (h.data || (h.data = {}),
                    h = h.data);
        ...
        removeData: function(e, a, b) {
            if (c.acceptData(e)) {
                var d, h, g, l = e.nodeType, f = l ? c.cache : e, i = l ? e[c.expando] : c.expando;
                if (f[i]) {
                    if (a && (d = b ? f[i] : f[i].data)) {
                        c.isArray(a) || (a in d ? a = [a] : (a = c.camelCase(a),
                        a in d ? a = [a] : a = a.split(" ")));
                        h = 0;
                        for (g = a.length; h < g; h++)
                            delete d[a[h]];
                        if (!(b ? R : c.isEmptyObject)(d))
                            return
                    }
                    if (!b && (delete f[i].data,
                    !R(f[i])))
                        return;
        ...
        acceptData: function(e) {
            if (e.nodeName) {
                ...
                if (a)
                    return !0 !== a && e.getAttribute("classid") === a
            }
            return !0
        }
    });
    c.fn.extend({
        data: function(e, a) {
            ...
            if ("undefined" == typeof e) {
                if (this.length && (g = c.data(this[0]),
                1 === this[0].nodeType && !c._data(this[0], "parsedAttrs"))) {
                    d = this[0].attributes;
                    for (var l = 0, f = d.length; l < f; l++)
                        h = d[l].name,
                        0 === h.indexOf("data-") && (h = c.camelCase(h.substring(5)),
                        M(this[0], h, g[h]));
            ...
            b = e.split(".");
            b[1] = b[1] ? "." + b[1] : "";
            return a === m ? (g = this.triggerHandler("getData" + b[1] + "!", [b[0]]),
            g === m && this.length && (g = c.data(this[0], e),
            g = M(this[0], e, g)),
            g === m && b[1] ? this.data(b[0]) : g) : this.each(function() {
                var d = c(this)
                  , h = [b[0], a];
    ...
    c.extend({
        _mark: function(e, a) {
            e && (a = (a || "fx") + "mark",
            c._data(e, a, (c._data(e, a) || 0) + 1))
        },
        _unmark: function(e, a, b) {
            !0 !== e && (b = a,
            a = e,
            e = !1);
            if (a) {
                var b = b || "fx"
                  , d = b + "mark";
                (e = e ? 0 : (c._data(a, d) || 1) - 1) ? c._data(a, d, e) : (c.removeData(a, d, !0),
                U(a, b, "mark"))
            }
        },
        ...
        dequeue: function(e, a) {
            ...
            d && ("fx" === a && b.unshift("inprogress"),
            c._data(e, a + ".run", h),
            d.call(e, function() {
                c.dequeue(e, a)
            }, h));
            b.length || (c.removeData(e, a + "queue " + a + ".run", !0),
            U(e, a, "queue"))
        }
    });
    c.fn.extend({
        ...
        promise: function(e) {
            ...
            "string" != typeof e && (e = m);
            for (var e = e || "fx", b = c.Deferred(), d = this, h = d.length, g = 1, l = e + "defer", f = e + "queue", e = e + "mark", i; h--; )
                if (i = c.data(d[h], l, m, !0) || (c.data(d[h], f, m, !0) || c.data(d[h], e, m, !0)) && c.data(d[h], l, c.Callbacks("once memory"), !0))
                    g++,
                    i.add(a);
            a();
            return b.promise()
    ...
    var qb = /[\n\t\r]/g, Ma = /\s+/, ic = /\r/g, jc = /^(?:button|input)$/i, kc = /^(?:button|input|object|select|textarea)$/i, lc = /^a(?:rea)?$/i, rb = /^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$/i, sb = c.support.getSetAttribute, ia, tb, ub;
    c.fn.extend({
        attr: function(e, a) {
        ...
        toggleClass: function(e, a) {
            ...
            return c.isFunction(e) ? this.each(function(b) {
                ...
                if ("string" === b)
                    for (var h, g = 0, l = c(this), f = a, i = e.split(Ma); h = i[g++]; )
                        f = d ? f : !l.hasClass(h),
                        l[f ? "addClass" : "removeClass"](h);
                else if ("undefined" === b || "boolean" === b)
                    this.className && c._data(this, "__className__", this.className),
                    this.className = this.className || !1 === e ? "" : c._data(this, "__className__") || ""
            })
        },
        hasClass: function(e) {
            for (var e = " " + e + " ", a = 0, b = this.length; a < b; a++)
                if (1 === this[a].nodeType && -1 < (" " + this[a].className + " ").replace(qb, " ").indexOf(e))
                    return !0;
            return !1
        },
        val: function(e) {
            ...
            if (!arguments.length) {
                if (h) {
                    if ((a = c.valHooks[h.nodeName.toLowerCase()] || c.valHooks[h.type]) && "get"in a && (b = a.get(h, "value")) !== m)
                        return b;
                    b = h.value;
            ...
            return this.each(function(b) {
                var h = c(this), g;
                if (1 === this.nodeType && (d ? g = e.call(this, b, h.val()) : g = e,
                null == g ? g = "" : "number" == typeof g ? g += "" : c.isArray(g) && (g = c.map(g, function(e) {
                    return e == null ? "" : e + ""
                })),
                a = c.valHooks[this.nodeName.toLowerCase()] || c.valHooks[this.type],
                !a || !("set"in a) || a.set(this, g, "value") === m))
                    this.value = g
            })
        }
    });
    c.extend({
        valHooks: {
            ...
            select: {
                get: function(e) {
                    var a, b, d = e.selectedIndex, h = [], g = e.options, l = "select-one" === e.type;
                    if (0 > d)
                        return null;
                    e = l ? d : 0;
                    for (b = l ? d + 1 : g.length; e < b; e++)
                        if (a = g[e],
                        a.selected && (c.support.optDisabled ? !a.disabled : null === a.getAttribute("disabled")) && (!a.parentNode.disabled || !c.nodeName(a.parentNode, "optgroup"))) {
                            a = c(a).val();
                            if (l)
                                return a;
                            h.push(a)
        ...
        attr: function(e, a, b, d) {
            ...
            if (!("getAttribute"in e))
                return c.prop(e, a, b);
            (d = 1 !== l || !c.isXMLDoc(e)) && (a = a.toLowerCase(),
            g = c.attrHooks[a] || (rb.test(a) ? tb : ia));
            if (b !== m) {
                if (null === b)
                    return c.removeAttr(e, a),
                    m;
                if (g && "set"in g && d && (h = g.set(e, b, a)) !== m)
                    return h;
                e.setAttribute(a, "" + b);
                return b
            }
            if (g && "get"in g && d && null !== (h = g.get(e, a)))
                return h;
            h = e.getAttribute(a);
            return null === h ? m : h
        },
        ...
        attrHooks: {
            type: {
                set: function(e, a) {
                    if (jc.test(e.nodeName) && e.parentNode)
        ...
        prop: function(e, a, b) {
            ...
            if (!e || 3 === g || 8 === g || 2 === g)
                return m;
            (1 !== g || !c.isXMLDoc(e)) && (a = c.propFix[a] || a,
            h = c.propHooks[a]);
    ...
    tb = {
        ...
        set: function(e, a, b) {
            var d;
            !1 === a ? c.removeAttr(e, b) : (d = c.propFix[b] || b,
            d in e && (e[d] = !0),
            e.setAttribute(b, b.toLowerCase()));
            return b
        }
    };
    sb || (ub = {
    ...
    c.support.hrefNormalized || c.each(["href", "src", "width", "height"], function(e, a) {
        c.attrHooks[a] = c.extend(c.attrHooks[a], {
            get: function(e) {
    ...
    c.each(["radio", "checkbox"], function() {
        c.valHooks[this] = c.extend(c.valHooks[this], {
            set: function(e, a) {
                if (c.isArray(a))
                    return e.checked = 0 <= c.inArray(c(e).val(), a)
            }
        })
    });
    ...
    c.event = {
        add: function(e, a, b, d, h) {
            ...
            if (!(3 === e.nodeType || 8 === e.nodeType || !a || !b || !(g = c._data(e)))) {
                b.handler && (k = b,
                b = k.handler);
                b.guid || (b.guid = c.guid++);
                (f = g.events) || (g.events = f = {});
                (l = g.handle) || (g.handle = l = function(e) {
                ...
                for (g = 0; g < a.length; g++) {
                    ...
                    if (h) {
                        z = i;
                        var v = pc.exec(h);
                        v && (v[1] = (v[1] || "").toLowerCase(),
                        v[3] = v[3] && RegExp("(?:^|\\s)" + v[3] + "(?:\\s|$)"));
                        z.quick = v;
                        !i.quick && c.expr.match.POS.test(h) && (i.isPositional = !0)
                    }
                    z = f[j];
                    if (!z && (z = f[j] = [],
                    z.delegateCount = 0,
                    !p.setup || !1 === p.setup.call(e, d, t, l)))
                        e.addEventListener ? e.addEventListener(j, l, !1) : e.attachEvent && e.attachEvent("on" + j, l);
                    p.add && (p.add.call(e, i),
                    i.handler.guid || (i.handler.guid = b.guid));
        ...
        remove: function(e, a, b, d) {
            var h = c.hasData(e) && c._data(e), g, l, f, i, j, t, k, z, p, m;
            if (h && (t = h.events)) {
                a = wb(a || "").split(" ");
                for (g = 0; g < a.length; g++) {
                    l = vb.exec(a[g]) || [];
                    ...
                    if (b || l || d || k.remove)
                        for (j = 0; j < p.length; j++) {
                            if (m = p[j],
                            !b || b.guid === m.guid)
                                if (!l || l.test(m.namespace))
                                    if (!d || d === m.selector || "**" === d && m.selector)
                                        p.splice(j--, 1),
                        ...
                        p.length = 0;
                    0 === p.length && i !== p.length && ((!k.teardown || !1 === k.teardown.call(e, l)) && c.removeEvent(e, f, h.handle),
                    delete t[f])
                }
                c.isEmptyObject(t) && (z = h.handle,
                z && (z.elem = null),
                c.removeData(e, ["events", "handle"], !0))
            }
        },
        customEvent: {
            getData: !0,
        ...
        trigger: function(e, a, b, d) {
            if (!b || 3 !== b.nodeType && 8 !== b.nodeType) {
                var h = e.type || e, g = [], l, f, i, t, k;
                0 <= h.indexOf("!") && (h = h.slice(0, -1),
                l = !0);
                0 <= h.indexOf(".") && (g = h.split("."),
                h = g.shift(),
                g.sort());
                if (b && !c.event.customEvent[h] || c.event.global[h])
                    if (e = "object" == typeof e ? e[c.expando] ? e : new c.Event(h,e) : new c.Event(h),
                    e.type = h,
                    e.isTrigger = !0,
                    e.exclusive = l,
                    e.namespace = g.join("."),
                    ...
                    g = 0 > h.indexOf(":") ? "on" + h : "",
                    (d || !b) && e.preventDefault(),
                    b) {
                        if (e.result = m,
                        e.target || (e.target = b),
                        a = null != a ? c.makeArray(a) : [],
                        a.unshift(e),
                        l = c.event.special[h] || {},
                        !(l.trigger && !1 === l.trigger.apply(b, a))) {
                            ...
                            if (!d && !l.noBubble && !c.isWindow(b)) {
                                f = l.delegateType || h;
                                i = null;
                                for (d = b.parentNode; d; d = d.parentNode)
                                    k.push([d, f]),
                                    i = d;
                                i && i === b.ownerDocument && k.push([i.defaultView || i.parentWindow || j, f])
                            }
                            for (f = 0; f < k.length && !(d = k[f][0],
                            e.type = k[f][1],
                            (t = (c._data(d, "events") || {})[e.type] && c._data(d, "handle")) && t.apply(d, a),
                            (t = g && d[g]) && c.acceptData(d) && t.apply(d, a),
                            e.isPropagationStopped()); f++)
                                ;
                            e.type = h;
                            e.isDefaultPrevented() || (!l._default || !1 === l._default.apply(b.ownerDocument, a)) && ("click" !== h || !c.nodeName(b, "a")) && c.acceptData(b) && g && b[h] && ("focus" !== h && "blur" !== h || 0 !== e.target.offsetWidth) && !c.isWindow(b) && (i = b[g],
                            i && (b[g] = null),
                            c.event.triggered = h,
                            b[h](),
                            c.event.triggered = m,
                        ...
                        for (f in b = c.cache,
                        b)
                            b[f].events && b[f].events[h] && c.event.trigger(e, a, b[f].handle.elem, !0)
            }
        },
        dispatch: function(e) {
            var e = c.event.fix(e || j.event), a = (c._data(this, "events") || {})[e.type] || [], b = a.delegateCount, d = [].slice.call(arguments, 0), h = !e.exclusive && !e.namespace, g = (c.event.special[e.type] || {}).handle, l = [], f, i, t, k, z, p, v;
            d[0] = e;
            e.delegateTarget = this;
            if (b && !e.target.disabled && (!e.button || "click" !== e.type))
            ...
            for (f = 0; f < l.length && !e.isPropagationStopped(); f++) {
                ...
                for (a = 0; a < b.matches.length && !e.isImmediatePropagationStopped(); a++)
                    if (t = b.matches[a],
                    h || !e.namespace && !t.namespace || e.namespace_re && e.namespace_re.test(t.namespace))
                        e.data = t.data,
                        e.handleObj = t,
        ...
        mouseHooks: {
            ...
            filter: function(e, a) {
                var b, c, d, h = a.button, g = a.fromElement;
                null == e.pageX && null != a.clientX && (b = e.target.ownerDocument || o,
                c = b.documentElement,
                d = b.body,
                e.pageX = a.clientX + (c && c.scrollLeft || d && d.scrollLeft || 0) - (c && c.clientLeft || d && d.clientLeft || 0),
                e.pageY = a.clientY + (c && c.scrollTop || d && d.scrollTop || 0) - (c && c.clientTop || d && d.clientTop || 0));
                !e.relatedTarget && g && (e.relatedTarget = g === e.target ? a.toElement : g);
                !e.which && h !== m && (e.which = h & 1 ? 1 : h & 2 ? 3 : h & 4 ? 2 : 0);
                return e
            }
        },
        fix: function(e) {
            if (e[c.expando])
                return e;
            var a, b, d = e, h = c.event.fixHooks[e.type] || {}, g = h.props ? this.props.concat(h.props) : this.props, e = c.Event(d);
            for (a = g.length; a; )
                b = g[--a],
                e[b] = d[b];
    ...
    c.removeEvent = o.removeEventListener ? function(e, a, b) {
    ...
    c.Event = function(e, a) {
        if (!(this instanceof c.Event))
            return new c.Event(e,a);
        e && e.type ? (this.originalEvent = e,
        this.type = e.type,
        this.isDefaultPrevented = e.defaultPrevented || !1 === e.returnValue || e.getPreventDefault && e.getPreventDefault() ? k : B) : this.type = e;
        a && c.extend(this, a);
    ...
    c.each({
        ...
        c.event.special[e] = c.event.special[a] = {
            ...
            bindType: a,
            handle: function(e) {
                var a = e.relatedTarget, b = e.handleObj, d;
                if (!a || b.origType === e.type || a !== this && !c.contains(this, a))
                    a = e.type,
                    e.type = b.origType,
    ...
    c.support.submitBubbles || (c.event.special.submit = {
        setup: function() {
            ...
            c.event.add(this, "click._submit keypress._submit", function(e) {
                e = e.target;
                (e = c.nodeName(e, "input") || c.nodeName(e, "button") ? e.form : m) && !e._submit_attached && (c.event.add(e, "submit._submit", function(e) {
    ...
    c.support.changeBubbles || (c.event.special.change = {
        setup: function() {
            ...
            c.event.add(this, "beforeactivate._change", function(e) {
                e = e.target;
                cb.test(e.nodeName) && !e._change_attached && (c.event.add(e, "change._change", function(e) {
        ...
        handle: function(e) {
            var a = e.target;
            if (this !== a || e.isSimulated || e.isTrigger || "radio" !== a.type && "checkbox" !== a.type)
    ...
    c.fn.extend({
        on: function(e, a, b, d, h) {
            ...
            null == b && null == d ? (d = a,
            b = a = m) : null == d && ("string" == typeof a ? (d = b,
            b = m) : (d = b,
            b = a,
            a = m));
            if (!1 === d)
        ...
        triggerHandler: function(e, a) {
            if (this[0])
                return c.event.trigger(e, a, this[0], !0)
        },
        toggle: function(e) {
            var a = arguments
              , b = e.guid || c.guid++
    ...
    c.each("blur focus focusin focusout load resize scroll unload click dblclick mousedown mouseup mousemove mouseover mouseout mouseenter mouseleave change select submit keydown keypress keyup error contextmenu".split(" "), function(e, a) {
        c.fn[a] = function(e, b) {
            b == null && (b = e,
            e = null);
    ...
    var A = function(e, a, b, d) {
        ...
        if (!e || "string" != typeof e)
            return b;
        var h, g, l, f, i, t, j = !0, k = A.isXML(a), z = [], p = e;
        do
            if (db.exec(""),
            h = db.exec(p))
                if (p = h[3],
        ...
        while (h);
        if (1 < z.length && rc.exec(e))
            if (2 === z.length && H.relative[z[0]])
                g = Bb(z[0] + z[1], a, d);
            else
                for (g = H.relative[z[0]] ? [a] : A(z.shift(), a); z.length; )
                    e = z.shift(),
                    H.relative[e] && (e += z.shift()),
                    g = Bb(e, g, d);
        else if (!d && 1 < z.length && 9 === a.nodeType && !k && H.match.ID.test(z[0]) && !H.match.ID.test(z[z.length - 1]) && (i = A.find(z.shift(), a, k),
        a = i.expr ? A.filter(i.expr, i.set)[0] : i.set[0]),
        a) {
            i = d ? {
                expr: z.pop(),
                set: ca(d)
            ...
            for (0 < z.length ? l = ca(g) : j = !1; z.length; )
                h = t = z.pop(),
        ...
        l || (l = g);
        l || A.error(t || e);
        if ("[object Array]" === zb.call(l))
            if (j)
                if (a && 1 === a.nodeType)
                    for (e = 0; null != l[e]; e++)
                        l[e] && (!0 === l[e] || 1 === l[e].nodeType && A.contains(a, l[e])) && b.push(g[e]);
                else
                    for (e = 0; null != l[e]; e++)
                        l[e] && 1 === l[e].nodeType && b.push(g[e]);
            else
                b.push.apply(b, l);
        else
            ca(l, b);
    ...
    A.find = function(e, a, b) {
        ...
        if (!e)
            return [];
        c = 0;
        for (h = H.order.length; c < h; c++)
            if (l = H.order[c],
            g = H.leftMatch[l].exec(e))
                if (f = g[1],
                g.splice(1, 1),
                "\\" !== f.substr(f.length - 1) && (g[1] = (g[1] || "").replace(ua, ""),
                d = H.find[l](g, a, b),
                null != d)) {
    ...
    A.filter = function(e, a, b, d) {
        for (var c, h, g, l, f, i, t, j, k = e, z = [], p = a, v = a && a[0] && A.isXML(a[0]); e && a.length; ) {
            for (g in H.filter)
                if (null != (c = H.leftMatch[g].exec(e)) && c[2])
                    if (i = H.filter[g],
                    f = c[1],
                    h = !1,
                    c.splice(1, 1),
                    "\\" !== f.substr(f.length - 1)) {
                        p === z && (z = []);
                        if (H.preFilter[g])
                            if (c = H.preFilter[g](c, p, b, z, d, v)) {
                                if (!0 === c)
                                    continue
                            } else
                                h = l = !0;
                        if (c)
                            for (t = 0; null != (f = p[t]); t++)
                                f && (l = i(f, c, t, p),
                                j = d ^ l,
                                b && null != l ? j ? h = !0 : p[t] = !1 : j && (z.push(f),
                                h = !0));
                        if (l !== m) {
                            b || (p = z);
    ...
    , H = A.selectors = {
        ...
        relative: {
            "+": function(e, a) {
                var b = "string" == typeof a
                  ...
                  , b = b && !d;
                d && (a = a.toLowerCase());
                for (var d = 0, c = e.length, h; d < c; d++)
                    if (h = e[d]) {
            ...
            ">": function(e, a) {
                var b, d = "string" == typeof a, c = 0, h = e.length;
                if (d && !Oa.test(a))
                    for (a = a.toLowerCase(); c < h; c++) {
                        if (b = e[c])
                            b = b.parentNode,
                    ...
                    for (; c < h; c++)
                        (b = e[c]) && (e[c] = d ? b.parentNode : b.parentNode === a);
                    d && A.filter(a, e, !0)
                }
            },
            "": function(e, a, b) {
                var d, c = eb++, h = xb;
                "string" == typeof a && !Oa.test(a) && (a = a.toLowerCase(),
                d = a,
                h = yb);
        ...
        find: {
            ID: function(e, a, b) {
                if ("undefined" != typeof a.getElementById && !b)
                    return (e = a.getElementById(e[1])) && e.parentNode ? [e] : []
            },
            NAME: function(e, a) {
                if ("undefined" != typeof a.getElementsByName) {
                    for (var b = [], d = a.getElementsByName(e[1]), c = 0, h = d.length; c < h; c++)
                        d[c].getAttribute("name") === e[1] && b.push(d[c]);
        ...
        preFilter: {
            CLASS: function(e, a, b, d, c, h) {
                ...
                if (h)
                    return e;
                for (var h = 0, g; null != (g = a[h]); h++)
                    g && (c ^ (g.className && 0 <= (" " + g.className + " ").replace(/[\t\n\r]/g, " ").indexOf(e)) ? b || d.push(g) : b && (a[h] = !1));
                return !1
            },
            ID: function(e) {
            ...
            ATTR: function(e, a, b, d, c, h) {
                a = e[1] = e[1].replace(ua, "");
                !h && H.attrMap[a] && (e[1] = H.attrMap[a]);
            ...
            PSEUDO: function(e, a, b, d, c) {
                if ("not" === e[1])
                    if (1 < (db.exec(e[3]) || "").length || /^\w/.test(e[3]))
                        e[3] = A(e[3], null, null, a);
                    else
                        return e = A.filter(e[3], a, b, 1 ^ c),
                        b || d.push.apply(d, e),
                        !1;
        ...
        filter: {
            PSEUDO: function(a, b, d, c) {
                ...
                if (g)
                    return g(a, d, b, c);
                if ("contains" === h)
                    return 0 <= (a.textContent || a.innerText || fb([a]) || "").indexOf(b[3]);
                if ("not" === h) {
                    b = b[3];
                    d = 0;
    ...
    }, rc = H.match.POS, sc = function(a, b) {
        return "\\" + (b - 0 + 1)
    }, Ba;
    for (Ba in H.match)
        H.match[Ba] = RegExp(H.match[Ba].source + /(?![^\[]*\])(?![^\(]*\))/.source),
    ...
    0 < ka.getElementsByTagName("*").length && (H.find.TAG = function(a, b) {
        ...
        if ("*" === a[1]) {
            for (var c = [], h = 0; d[h]; h++)
                1 === d[h].nodeType && c.push(d[h]);
            d = c
        }
        return d
    }
    );
    ka.innerHTML = "<a href='#'></a>";
            ...
            var A = function(a, b, d, c) {
                ...
                if (!c && !A.isXML(b)) {
                    ...
                    if (h && (1 === b.nodeType || 9 === b.nodeType)) {
                        if (h[1])
                            return ca(b.getElementsByTagName(a), d);
                        if (h[2] && H.find.CLASS && b.getElementsByClassName)
                            return ca(b.getElementsByClassName(h[2]), d)
                    }
                    if (9 === b.nodeType) {
                        if ("body" === a && b.body)
                            return ca([b.body], d);
                        ...
                        try {
                            if (!t || i)
                                return ca(b.querySelectorAll("[id='" + f + "'] " + a), d)
                        } catch (j) {} finally {
            ...
            if (!A.isXML(a))
                try {
                    if (Db || !H.match.PSEUDO.test(b) && !/!=/.test(b)) {
                        var d = Ua.call(a, b);
                        if (d || !tc || a.document && 11 !== a.document.nodeType)
                            return d
                    }
                } catch (c) {}
    ...
    va.innerHTML = "<div class='test e'></div><div class='test'></div>";
    va.getElementsByClassName && 0 !== va.getElementsByClassName("e").length && (va.lastChild.className = "e",
    1 !== va.getElementsByClassName("e").length && (H.order.splice(1, 0, "CLASS"),
    H.find.CLASS = function(a, b, d) {
        if ("undefined" != typeof b.getElementsByClassName && !d)
    ...
    c.fn.extend({
        find: function(a) {
            ...
            var g = this.pushStack("", "find", a), l, f, i;
            d = 0;
        ...
        closest: function(a, b) {
            ...
            for (g = this.length; h < g; h++)
                for (l = this[h]; l; ) {
                    ...
                    l = l.parentNode;
                    if (!l || !l.ownerDocument || l === b || l.nodeType === 11)
                        break
                }
    ...
    c.each({
        ...
        c.fn[a] = function(d, h) {
            ...
            g = this.length > 1 && !yc[a] ? c.unique(g) : g;
            (this.length > 1 || wc.test(h)) && vc.test(a) && (g = g.reverse());
    ...
    var ob = "abbr article aside audio canvas datalist details figcaption figure footer header hgroup mark meter nav output progress section summary time video"
      ...
      , Bc = /<|&#?\w+;/
      , Cc = /<(?:script|style)/i
      , Dc = /<(?:script|object|embed|option|style)/i
      , Ec = RegExp("<(?:" + ob.replace(" ", "|") + ")", "i")
    ...
    c.fn.extend({
        ...
        remove: function(a, b) {
            for (var d = 0, h; (h = this[d]) != null; d++)
                if (!a || c.filter(a, [h]).length) {
                    !b && h.nodeType === 1 && (c.cleanData(h.getElementsByTagName("*")),
                    c.cleanData([h]));
        ...
        html: function(a) {
            if (a === m)
                return this[0] && this[0].nodeType === 1 ? this[0].innerHTML.replace(zc, "") : null;
            if (typeof a == "string" && !Cc.test(a) && (c.support.leadingWhitespace || !ib.test(a)) && !X[(Gb.exec(a) || ["", ""])[1].toLowerCase()]) {
                a = a.replace(Fb, "<$1></$2>");
                try {
                    for (var b = 0, d = this.length; b < d; b++)
                        this[b].nodeType === 1 && (c.cleanData(this[b].getElementsByTagName("*")),
                        this[b].innerHTML = a)
                } catch (h) {
                    this.empty().append(a)
                }
        ...
        domManip: function(a, b, d) {
            var h, g, l, f = a[0], i = [];
            if (!c.support.checkClone && arguments.length === 3 && typeof f == "string" && Hb.test(f))
                return this.each(function() {
            ...
            if (this[0]) {
                ...
                if (g) {
                    b = b && c.nodeName(g, "tr");
                    g = 0;
                    for (var t = this.length, j = t - 1; g < t; g++)
                        d.call(b ? c.nodeName(this[g], "table") ? this[g].getElementsByTagName("tbody")[0] || this[g].appendChild(this[g].ownerDocument.createElement("tbody")) : this[g] : this[g], h.cacheable || t > 1 && g < j ? c.clone(l, true, true) : l)
                }
                i.length && c.each(i, Y)
            }
            return this
    ...
    c.buildFragment = function(a, b, d) {
        ...
        a.length === 1 && typeof i == "string" && i.length < 512 && f === o && i.charAt(0) === "<" && !Dc.test(i) && (c.support.checkClone || !Hb.test(i)) && !c.support.unknownElems && Ec.test(i) && (g = true,
        l = c.fragments[i],
        l && l !== 1 && (h = l));
        h || (h = f.createDocumentFragment(),
        c.clean(a, f, h, d));
    ...
    c.extend({
        ...
        clean: function(a, b, d, h) {
                ...
                if (i) {
                    if (typeof i == "string")
                        if (Bc.test(i)) {
                            ...
                            for (k.innerHTML = t[1] + i + t[2]; j--; )
                                k = k.lastChild;
                            if (!c.support.tbody) {
                                j = Ac.test(i);
                                t = l === "table" && !j ? k.firstChild && k.firstChild.childNodes : t[1] === "<table>" && !j ? k.childNodes : [];
                                for (l = t.length - 1; l >= 0; --l)
                                    c.nodeName(t[l], "tbody") && !t[l].childNodes.length && t[l].parentNode.removeChild(t[l])
                            }
                    ...
                    if (!c.support.appendChecked)
                        if (i[0] && typeof (z = i.length) == "number")
                            for (l = 0; l < z; l++)
                                ea(i[l]);
                        else
                            ea(i);
            ...
            if (d) {
                ...
                ;
                for (f = 0; g[f]; f++)
                    if (h && c.nodeName(g[f], "script") && (!g[f].type || g[f].type.toLowerCase() === "text/javascript"))
                        h.push(g[f].parentNode ? g[f].parentNode.removeChild(g[f]) : g[f]);
                    else {
                        if (g[f].nodeType === 1) {
        ...
        cleanData: function(a) {
            for (var b, d, h = c.cache, g = c.event.special, l = c.support.deleteExpando, f = 0, i; (i = a[f]) != null; f++)
                if (!i.nodeName || !c.noData[i.nodeName.toLowerCase()])
                    if (d = i[c.expando]) {
                        if ((b = h[d]) && b.events) {
                            for (var t in b.events)
                                g[t] ? c.event.remove(i, t) : c.removeEvent(i, t, b.handle);
    ...
    var jb = /alpha\([^)]*\)/i, Hc = /opacity=([^)]*)/, Ic = /([A-Z]|^ms)/g, Ib = /^-?\d+(?:px)?$/i, Jc = /^-?\d/, Kc = /^([\-+])=([\-+.\de]+)/, Lc = {
        position: "absolute",
        visibility: "hidden",
        display: "block"
    }, Tb = ["Left", "Right"], Ub = ["Top", "Bottom"], oa, Jb, Kb;
    c.fn.css = function(a, b) {
        return arguments.length === 2 && b === m ? this : c.access(this, a, b, true, function(a, b, d) {
    ...
    c.extend({
        ...
        style: function(a, b, d, h) {
            if (a && a.nodeType !== 3 && a.nodeType !== 8 && a.style) {
                var g, l = c.camelCase(b), f = a.style, i = c.cssHooks[l], b = c.cssProps[l] || l;
                if (d === m)
                    return i && "get"in i && (g = i.get(a, false, h)) !== m ? g : f[b];
                h = typeof d;
                h === "string" && (g = Kc.exec(d)) && (d = +(g[1] + 1) * +g[2] + parseFloat(c.css(a, b)),
                h = "number");
                if (!(d == null || h === "number" && isNaN(d))) {
                    h === "number" && !c.cssNumber[l] && (d = d + "px");
                    if (!i || !("set"in i) || (d = i.set(a, d)) !== m)
                        try {
                            f[b] = d
                        } catch (t) {}
                }
        ...
        css: function(a, b, d) {
            ...
            b = c.cssProps[b] || b;
            b === "cssFloat" && (b = "float");
            if (g && "get"in g && (h = g.get(a, true, d)) !== m)
                return h;
            if (oa)
                return oa(a, b)
        },
    ...
    o.defaultView && o.defaultView.getComputedStyle && (Jb = function(a, b) {
        ...
        if (!(h = a.ownerDocument.defaultView))
            return m;
    ...
    o.documentElement.currentStyle && (Kb = function(a, b) {
        var d, c, h, g = a.currentStyle && a.currentStyle[b], l = a.style;
        g === null && l && (h = l[b]) && (g = h);
        !Ib.test(g) && Jc.test(g) && (d = l.left,
        c = a.runtimeStyle && a.runtimeStyle.left,
        c && (a.runtimeStyle.left = a.currentStyle.left),
        l.left = b === "fontSize" ? "1em" : g || 0,
        g = l.pixelLeft + "px",
        l.left = d,
    ...
    var Mc = /%20/g, Sb = /\[\]$/, Lb = /\r?\n/g, Nc = /#.*$/, Oc = /^(.*?):[ \t]*([^\r\n]*)\r?$/mg, Pc = /^(?:color|date|datetime|datetime-local|email|hidden|month|number|password|range|search|tel|text|time|url|week)$/i, Qc = /^(?:GET|HEAD)$/, Rc = /^\/\//, Mb = /\?/, Sc = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, Tc = /^(?:select|textarea)/i, nb = /\s+/, Uc = /([?&])_=[^&]*/, Nb = /^([\w\+\.\-]+:)(?:\/\/([^\/?#:]*)(?::(\d+))?)?/, Ob = c.fn.load, Ya = {}, Pb = {}, la, ma, Qb = ["*/"] + ["*"];
    try {
        la = F.href
    } catch (cd) {
        la = o.createElement("a"),
        la.href = "",
        la = la.href
    }
    ma = Nb.exec(la.toLowerCase()) || [];
    c.fn.extend({
        load: function(a, b, d) {
            if (typeof a != "string" && Ob)
            ...
            if (h >= 0)
                var g = a.slice(h, a.length)
                  , a = a.slice(0, h);
            h = "GET";
            b && (c.isFunction(b) ? (d = b,
            b = m) : typeof b == "object" && (b = c.param(b, c.ajaxSettings.traditional),
            h = "POST"));
            var l = this;
            c.ajax({
                url: a,
                ...
                complete: function(a, b, e) {
                    ...
                    l.html(g ? c("<div>").append(e.replace(Sc, "")).find(g) : e));
                    d && l.each(d, [e, b, a])
                }
            });
            return this
        ...
        serializeArray: function() {
            return this.map(function() {
                ...
                return this.name && !this.disabled && (this.checked || Tc.test(this.nodeName) || Pc.test(this.type))
            }).map(function(a, b) {
                var d = c(this).val();
    ...
    c.each(["get", "post"], function(a, b) {
        c[b] = function(a, d, e, h) {
            c.isFunction(d) && (h = h || e,
            e = d,
            d = m);
            return c.ajax({
                type: b,
        ...
        ajax: function(a, b) {
            function d(a, b, e, n) {
                if (r !== 2) {
                    ...
                    o = m;
                    p = n || "";
                    I.readyState = a > 0 ? 4 : 0;
                    var k, z, v, n = b;
                    if (e) {
                        var xa = h, q = I, s = xa.contents, u = xa.dataTypes, K = xa.responseFields, A, w, x, Q;
                        for (w in K)
                            w in e && (q[K[w]] = e[w]);
                        for (; u[0] === "*"; ) {
                            u.shift();
                            A === m && (A = xa.mimeType || q.getResponseHeader("content-type"))
                        }
                        if (A)
                            for (w in s)
                                if (s[w] && s[w].test(A)) {
                    ...
                    if (a >= 200 && a < 300 || a === 304) {
                        if (h.ifModified) {
                            if (A = I.getResponseHeader("Last-Modified"))
                                c.lastModified[j] = A;
                            if (A = I.getResponseHeader("Etag"))
                                c.etag[j] = A
                        }
                        if (a === 304) {
                            n = "notmodified";
                            ...
                            try {
                                A = h;
                                A.dataFilter && (e = A.dataFilter(e, A.dataType));
                                var C = A.dataTypes;
                                w = {};
                                var G, fa, H = C.length, B, E = C[0], y, pa, D, ga, ha;
                                for (G = 1; G < H; G++) {
                                    if (G === 1)
                                        for (fa in A.converters)
                                            typeof fa == "string" && (w[fa.toLowerCase()] = A.converters[fa]);
                                    y = E;
                                    E = C[G];
                                    if (E === "*")
                                        E = y;
                                        ...
                                        if (!D) {
                                            ...
                                            for (ga in w) {
                                                ...
                                                if (B[0] === y || B[0] === "*")
                                                    if (ha = w[B[1] + " " + E]) {
                                                        ga = w[ga];
                                                        ga === true ? D = ha : ha === true && (D = ga);
                                                        break
                                                    }
                                            }
                                        }
                                        !D && !ha && c.error("No conversion from " + pa.replace(" ", " to "));
                                        D !== true && (e = D ? D(e) : ha(ga(e)))
                                    }
                                }
                                z = e;
                                n = "success";
                    ...
                    I.status = a;
                    I.statusText = "" + (b || n);
                    k ? f.resolveWith(g, [z, n, I]) : f.rejectWith(g, [I, n, v]);
                    I.statusCode(t);
                    t = m;
                    ja && l.trigger("ajax" + (k ? "Success" : "Error"), [I, h, k ? z : v]);
                    i.fireWith(g, [I, n]);
                    ja && (l.trigger("ajaxComplete", [I, h]),
                    --c.active || c.event.trigger("ajaxStop"))
                }
            }
            typeof a == "object" && (b = a,
            a = m);
            var b = b || {}, h = c.ajaxSetup({}, b), g = h.context || h, l = g !== h && (g.nodeType || g instanceof c) ? c(g) : c.event, f = c.Deferred(), i = c.Callbacks("once memory"), t = h.statusCode || {}, j, k = {}, z = {}, p, v, o, ya, q, r = 0, ja, s, I = {
                readyState: 0,
            ...
            ;
            h.url = ((a || h.url) + "").replace(Nc, "").replace(Rc, ma[1] + "//");
            h.dataTypes = c.trim(h.dataType || "*").toLowerCase().split(nb);
            h.crossDomain == null && (q = Nb.exec(h.url.toLowerCase()),
            h.crossDomain = !(!q || q[1] == ma[1] && q[2] == ma[2] && (q[3] || (q[1] === "http:" ? 80 : 443)) == (ma[3] || (ma[1] === "http:" ? 80 : 443))));
            h.data && h.processData && typeof h.data != "string" && (h.data = c.param(h.data, h.traditional));
            J(Ya, h, b, I);
            if (r === 2)
                return false;
            ja = h.global;
            h.type = h.type.toUpperCase();
            h.hasContent = !Qc.test(h.type);
            ja && c.active++ === 0 && c.event.trigger("ajaxStart");
            if (!h.hasContent) {
                h.data && (h.url = h.url + ((Mb.test(h.url) ? "&" : "?") + h.data),
                delete h.data);
                j = h.url;
                if (h.cache === false) {
                    q = c.now();
                    var u = h.url.replace(Uc, "$1_=" + q);
                    h.url = u + (u === h.url ? (Mb.test(h.url) ? "&" : "?") + "_=" + q : "")
                }
            }
            (h.data && h.hasContent && h.contentType !== false || b.contentType) && I.setRequestHeader("Content-Type", h.contentType);
            h.ifModified && (j = j || h.url,
            c.lastModified[j] && I.setRequestHeader("If-Modified-Since", c.lastModified[j]),
            c.etag[j] && I.setRequestHeader("If-None-Match", c.etag[j]));
            I.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + (h.dataTypes[0] !== "*" ? ", " + Qb + "; q=0.01" : "") : h.accepts["*"]);
            for (s in h.headers)
                I.setRequestHeader(s, h.headers[s]);
            if (h.beforeSend && (h.beforeSend.call(g, I, h) === false || r === 2)) {
                I.abort();
                return false
            }
            for (s in {
            ...
            if (o = J(Pb, h, b, I)) {
                I.readyState = 1;
                ja && l.trigger("ajaxSend", [I, h]);
                h.async && h.timeout > 0 && (ya = setTimeout(function() {
                    I.abort("timeout")
                }, h.timeout));
                try {
                    r = 1;
    ...
    c.ajaxSetup({
        ...
        jsonpCallback: function() {
            return c.expando + "_" + Vc++
        }
    });
    c.ajaxPrefilter("json jsonp", function(a, b, d) {
        b = a.contentType === "application/x-www-form-urlencoded" && typeof a.data == "string";
        if (a.dataTypes[0] === "jsonp" || a.jsonp !== false && (Va.test(a.url) || b && Va.test(a.data))) {
            var h, g = a.jsonpCallback = c.isFunction(a.jsonpCallback) ? a.jsonpCallback() : a.jsonpCallback, l = j[g], f = a.url, i = a.data, t = "$1" + g + "$2";
            a.jsonp !== false && (f = f.replace(Va, t),
            a.url === f && (b && (i = i.replace(Va, t)),
            a.data === i && (f = f + ((/\?/.test(f) ? "&" : "?") + a.jsonp + "=" + g))));
            a.url = f;
            a.data = i;
            j[g] = function(a) {
                h = [a]
            ...
            d.always(function() {
                j[g] = l;
                h && c.isFunction(l) && j[g](h[0])
            });
            a.converters["script json"] = function() {
                h || c.error(g + " was not called");
                return h[0]
            }
            ;
            a.dataTypes[0] = "json";
        ...
        if (a.crossDomain) {
            ...
            return {
                send: function(h, c) {
                    ...
                    b.src = a.url;
                    b.onload = b.onreadystatechange = function(a, h) {
    ...
    var kb = j.ActiveXObject ? function() {
        for (var a in wa)
            wa[a](0, 1)
    }
    : !1, Wc = 0, wa;
    c.ajaxSettings.xhr = j.ActiveXObject ? function() {
        var a;
        if (!(a = !this.isLocal && q()))
            a: {
                try {
    ...
    : q;
    var lb = c.ajaxSettings.xhr();
    c.extend(c.support, {
        ajax: !!lb,
        cors: !!lb && "withCredentials"in lb
    });
                        ...
                        try {
                            if (b && (f || g.readyState === 4)) {
                                ...
                                if (f)
                                    ...
                                    k = {};
                                    (z = g.responseXML) && z.documentElement && (k.xml = z);
                                    ...
                                    !i && a.isLocal && !a.crossDomain ? i = k.text ? 200 : 404 : i === 1223 && (i = 204)
                                }
                            }
                        } catch (v) {
                            f || h(-1, v)
    ...
    var Xa = {}, da, na, Xc = /^(?:toggle|show|hide)$/, Yc = /^([+\-]=)?([\d+.\-]+)([a-z%]*)$/i, Wa, mb = [["height", "marginTop", "marginBottom", "paddingTop", "paddingBottom"], ["width", "marginLeft", "marginRight", "paddingLeft", "paddingRight"], ["opacity"]], Da;
    c.fn.extend({
        show: function(a, b, d) {
            var h;
            if (a || a === 0)
                return this.animate(y("show", 3), a, b, d);
            b = 0;
            for (d = this.length; b < d; b++) {
                a = this[b];
                a.style && (h = a.style.display,
                !c._data(a, "olddisplay") && h === "none" && (h = a.style.display = ""),
                h === "" && c.css(a, "display") === "none" && c._data(a, "olddisplay", x(a.nodeName)))
            }
            for (b = 0; b < d; b++) {
                a = this[b];
                if (a.style) {
        ...
        hide: function(a, b, d) {
            if (a || a === 0)
                return this.animate(y("hide", 3), a, b, d);
            for (var h, b = 0, d = this.length; b < d; b++) {
                a = this[b];
                a.style && (h = c.css(a, "display"),
                h !== "none" && !c._data(a, "olddisplay") && c._data(a, "olddisplay", h))
            }
            for (b = 0; b < d; b++)
        ...
        toggle: function(a, b, d) {
            var h = typeof a == "boolean";
            c.isFunction(a) && c.isFunction(b) ? this._toggle.apply(this, arguments) : a == null || h ? this.each(function() {
                var b = h ? a : c(this).is(":hidden");
                c(this)[b ? "show" : "hide"]()
            }) : this.animate(y("toggle", 3), a, b, d);
            return this
        },
        ...
        animate: function(a, b, d, h) {
            function g() {
                l.queue === false && c._mark(this);
                var b = c.extend({}, l), d = this.nodeType === 1, h = d && c(this).is(":hidden"), f, i, t, j, k, n, z, p;
                ...
                for (t in a) {
                    ...
                    delete a[t]);
                    i = a[f];
                    c.isArray(i) ? (b.animatedProperties[f] = i[1],
                    i = a[f] = i[0]) : b.animatedProperties[f] = b.specialEasing && b.specialEasing[f] || b.easing || "swing";
                    if (i === "hide" && h || i === "show" && !h)
                        return b.complete.call(this);
                    d && (f === "height" || f === "width") && (b.overflow = [this.style.overflow, this.style.overflowX, this.style.overflowY],
                    c.css(this, "display") === "inline" && c.css(this, "float") === "none" && (!c.support.inlineBlockNeedsLayout || x(this.nodeName) === "inline" ? this.style.display = "inline-block" : this.style.zoom = 1))
                }
                b.overflow != null && (this.style.overflow = "hidden");
                for (t in a) {
                    d = new c.fx(this,b,t);
                    i = a[t];
                    Xc.test(i) ? (p = c._data(this, "toggle" + t) || (i === "toggle" ? h ? "show" : "hide" : 0),
                    p ? (c._data(this, "toggle" + t, p === "show" ? "hide" : "show"),
                    d[p]()) : d[i]()) : (j = Yc.exec(i),
                    k = d.cur(),
                    j ? (n = parseFloat(j[2]),
                    z = j[3] || (c.cssNumber[t] ? "" : "px"),
                    z !== "px" && (c.style(this, t, (n || 1) + z),
                    k = (n || 1) / d.cur() * k,
                    c.style(this, t, k + z)),
                    j[1] && (n = (j[1] === "-=" ? -1 : 1) * n + k),
                    d.custom(k, n, z)) : d.custom(k, i, ""))
                }
                return true
            }
            var l = c.speed(b, d, h);
            if (c.isEmptyObject(a))
                return this.each(l.complete, [false]);
            a = c.extend({}, a);
            return l.queue === false ? this.each(g) : this.queue(l.queue, g)
        },
        stop: function(a, b, d) {
            typeof a != "string" && (d = b,
            b = a,
            ...
            return this.each(function() {
                var b, h = false, g = c.timers, l = c._data(this);
                ...
                else if (l[b = a + ".run"] && l[b].stop) {
                    l = l[b];
                    c.removeData(this, b, true);
                    l.stop(d)
                }
                for (b = g.length; b--; )
                    g[b].elem === this && (a == null || g[b].queue === a) && (d ? g[b](true) : g[b].saveState(),
                    h = true,
                    g.splice(b, 1));
                (!d || !h) && c.dequeue(this, a)
            })
        }
    });
    c.each({
        ...
        c.fn[a] = function(a, d, h) {
            return this.animate(b, a, d, h)
        }
    });
    c.extend({
        speed: function(a, b, d) {
            var h = a && typeof a == "object" ? c.extend({}, a) : {
                complete: d || !d && b || c.isFunction(a) && a,
                duration: a,
                easing: d && b || b && !c.isFunction(b) && b
            };
            h.duration = c.fx.off ? 0 : typeof h.duration == "number" ? h.duration : h.duration in c.fx.speeds ? c.fx.speeds[h.duration] : c.fx.speeds._default;
            if (h.queue == null || h.queue === true)
                h.queue = "fx";
            h.old = h.complete;
            h.complete = function(a) {
                c.isFunction(h.old) && h.old.call(this);
                h.queue ? c.dequeue(this, h.queue) : a !== false && c._unmark(this)
            }
            ;
            return h
        },
        easing: {
            linear: function(a, b, d, h) {
                return d + h * a
            },
            swing: function(a, b, d, h) {
    ...
    c.fx.prototype = {
        ...
        custom: function(a, b, d) {
            ...
            h.saveState = function() {
                g.options.hide && c._data(g.elem, "fxshow" + g.prop) === m && c._data(g.elem, "fxshow" + g.prop, g.start)
            }
            ;
            h() && c.timers.push(h) && !Wa && (Wa = setInterval(l.tick, l.interval))
        },
        show: function() {
            var a = c._data(this.elem, "fxshow" + this.prop);
            this.options.orig[this.prop] = a || c.style(this.elem, this.prop);
            this.options.show = true;
            a !== m ? this.custom(this.cur(), a) : this.custom(this.prop === "width" || this.prop === "height" ? 1 : 0, this.cur());
            c(this.elem).show()
        },
        hide: function() {
        ...
        step: function(a) {
            var b, d, h = Da || r(), g = true, l = this.elem, f = this.options;
            if (a || h >= f.duration + this.startTime) {
                this.now = this.end;
                this.pos = this.state = 1;
                this.update();
                f.animatedProperties[this.prop] = true;
                for (b in f.animatedProperties)
                    f.animatedProperties[b] !== true && (g = false);
                if (g) {
                    f.overflow != null && !c.support.shrinkWrapBlocks && c.each(["", "X", "Y"], function(a, b) {
                        l.style["overflow" + b] = f.overflow[a]
                    });
                    f.hide && c(l).hide();
                    if (f.hide || f.show)
                        for (b in f.animatedProperties) {
                            c.style(l, b, f.orig[b]);
                            c.removeData(l, "fxshow" + b, true);
                            c.removeData(l, "toggle" + b, true)
                        }
                    (a = f.complete) && (f.complete = false,
                    a.call(l))
                }
                return false
            }
            f.duration == Infinity ? this.now = h : (d = h - this.startTime,
            this.state = d / f.duration,
            this.pos = c.easing[f.animatedProperties[this.prop]](this.state, d, 0, 1, f.duration),
    ...
    var Zc = /^t(?:able|d|h)$/i
      , Rb = /^(?:body|html)$/i;
    "getBoundingClientRect"in o.documentElement ? c.fn.offset = function(a) {
        var b = this[0], d;
        if (a)
            return this.each(function(b) {
        ...
        g = s(g);
        return {
            top: d.top + (g.pageYOffset || c.support.boxModel && l.scrollTop || b.scrollTop) - (l.clientTop || b.clientTop || 0),
            left: d.left + (g.pageXOffset || c.support.boxModel && l.scrollLeft || b.scrollLeft) - (l.clientLeft || b.clientLeft || 0)
        }
    }
    : c.fn.offset = function(a) {
        ...
        if (b === b.ownerDocument.body)
            return c.offset.bodyOffset(b);
        var d, h = b.offsetParent, g = b.ownerDocument, l = g.documentElement, f = g.body;
        d = (g = g.defaultView) ? g.getComputedStyle(b, null) : b.currentStyle;
        for (var i = b.offsetTop, t = b.offsetLeft; (b = b.parentNode) && b !== f && b !== l; ) {
            ...
            b === h && (i = i + b.offsetTop,
            t = t + b.offsetLeft,
            c.support.doesNotAddBorder && (!c.support.doesAddBorderForTableAndCells || !Zc.test(b.nodeName)) && (i = i + (parseFloat(d.borderTopWidth) || 0),
            t = t + (parseFloat(d.borderLeftWidth) || 0)),
            h = b.offsetParent);
            c.support.subtractsBorderForOverflowNotVisible && d.overflow !== "visible" && (i = i + (parseFloat(d.borderTopWidth) || 0),
            t = t + (parseFloat(d.borderLeftWidth) || 0))
        }
        ...
        c.support.fixedPosition && d.position === "fixed" && (i = i + Math.max(l.scrollTop, f.scrollTop),
        t = t + Math.max(l.scrollLeft, f.scrollLeft));
        return {
            top: i,
            left: t
        }
    ...
    c.offset = {
        bodyOffset: function(a) {
            var b = a.offsetTop
              , d = a.offsetLeft;
            c.support.doesNotIncludeMarginInBodyOffset && (b = b + (parseFloat(c.css(a, "marginTop")) || 0),
        ...
        setOffset: function(a, b, d) {
            var h = c.css(a, "position");
            h === "static" && (a.style.position = "relative");
            var g = c(a), l = g.offset(), f = c.css(a, "top"), i = c.css(a, "left"), t = {}, j = {}, k, z;
            (h === "absolute" || h === "fixed") && c.inArray("auto", [f, i]) > -1 ? (j = g.position(),
            k = j.top,
            z = j.left) : (k = parseFloat(f) || 0,
            z = parseFloat(i) || 0);
            c.isFunction(b) && (b = b.call(a, d, l));
            b.top != null && (t.top = b.top - l.top + k);
            b.left != null && (t.left = b.left - l.left + z);
    ...
    c.fn.extend({
        position: function() {
            ...
            var a = this[0]
              , b = this.offsetParent()
              , d = this.offset()
              , h = Rb.test(b[0].nodeName) ? {
                top: 0,
                left: 0
            } : b.offset();
            d.top = d.top - (parseFloat(c.css(a, "marginTop")) || 0);
            d.left = d.left - (parseFloat(c.css(a, "marginLeft")) || 0);
            h.top = h.top + (parseFloat(c.css(b[0], "borderTopWidth")) || 0);
            h.left = h.left + (parseFloat(c.css(b[0], "borderLeftWidth")) || 0);
            return {
                top: d.top - h.top,
                left: d.left - h.left
            }
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var a = this.offsetParent || o.body; a && !Rb.test(a.nodeName) && c.css(a, "position") === "static"; )
                    a = a.offsetParent;
                return a
            })
        }
    ...
    c.each(["Left", "Top"], function(a, b) {
        ...
        c.fn[d] = function(b) {
            ...
            if (b === m) {
                ...
                if (!h)
                    return null;
                return (g = s(h)) ? "pageXOffset"in g ? g[a ? "pageYOffset" : "pageXOffset"] : c.support.boxModel && g.document.documentElement[d] || g.document.body[d] : h[d]
            }
            return this.each(function() {
                (g = s(this)) ? g.scrollTo(a ? c(g).scrollLeft() : b, a ? b : c(g).scrollTop()) : this[d] = b
            })
        }
    });
    c.each(["Height", "Width"], function(a, b) {
        ...
        c.fn[d] = function(a) {
            ...
            if (c.isFunction(a))
                return this.each(function(b) {
                    var h = c(this);
                    h[d](a.call(this, b, h[d]()))
                });
            if (c.isWindow(h)) {
                var e = h.document.documentElement["client" + b]
                  , g = h.document.body;
                return h.document.compatMode === "CSS1Compat" && e || g && g["client" + b] || e
            }
            if (h.nodeType === 9)
                return Math.max(h.documentElement["client" + b], h.body["scroll" + b], h.documentElement["scroll" + b], h.body["offset" + b], h.documentElement["offset" + b]);
            if (a === m) {
                h = c.css(h, d);
                e = parseFloat(h);
                return c.isNumeric(e) ? e : h
            }
    ...
    var w, aa, k, B = Math.PI, U = B / 2, R = "ontouchstart"in window, M = {
        ...
        addPage: function(b, d, a) {
            ...
            if (d)
                ...
                d = i,
                g = !0;
            1 <= d && d <= i && (c = l.display == o["double"] ? d % 1 ? " odd" : " even" : " odd",
